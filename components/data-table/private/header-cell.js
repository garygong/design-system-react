	...
	render: function render() {
		...
		return _react2.default.createElement(
			'th',
			{
				...
				}, _defineProperty(_classNames, 'slds-is-sorted_' + sortDirection, sortDirection), _defineProperty(_classNames, 'slds-is-sorted_asc', isSorted && !sortDirection), _classNames), 'slds-text-title_caps'),
				scope: 'col',
				style: { width: width ? { width: width } : null }
			},
			this.props.fixedLayout ? fixedLayoutSubRenders[sortable ? 'sortable' : 'notSortable'] : _react2.default.createElement(
				'div',
				{
					className: 'slds-truncate',
					title: labelType === 'string' ? label : undefined
