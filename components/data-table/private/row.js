...
var DataTableRow = function DataTableRow(props) {
  ...
  var _contextHelper = (0, _contextHelper2.default)(tableContext, selectRowCellContext, props.fixedLayout),
  ...
  var ariaProps = {};
  var isSelected = !!(0, _lodash.default)(props.selection, props.item);
