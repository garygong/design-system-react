    ...
    value: function render() {
      ...
      _react.default.Children.forEach(this.props.children, function (child) {
        if (child && child.type.displayName === _column.default.displayName) {
          ...
          var props = (0, _lodash.default)({}, _this3.props); // eslint-disable-next-line fp/no-delete
      ...
      var component = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_tableContext.default.Provider, {
        ...
        var rowId = _this3.getId() && item.id ? "".concat(_this3.getId(), "-").concat(_constants.DATA_TABLE_ROW, "-").concat(item.id) : _shortid.default.generate();
